...
type ProjectContext struct {
	...
	DefaultShell      string   `json:"defaultShell,omitempty"`      // actual shell family used by exec, e.g. cmd.exe or sh
	ShellFlag         string   `json:"shellFlag,omitempty"`         // /C or -c
	ShellFamily       string   `json:"shellFamily,omitempty"`       // cmd | sh
	AvailableShells   []string `json:"availableShells,omitempty"`   // shells detected on PATH, advisory only
	PathSeparator     string   `json:"pathSeparator,omitempty"`     // os.PathSeparator for this client
	PathListSeparator string   `json:"pathListSeparator,omitempty"` // os.PathListSeparator for PATH-like lists
